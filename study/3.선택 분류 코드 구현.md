...
소프트 맥스는 3개 이상의 값을 분류할때 사용하며, 확률의 총합은 1이되고, 이 확률의 값은 실제 정답의 확률을 나타냅니다.
...
diff는 $x_i-x_k$를 계산한 값들이 모여져 있습니다. 이를 이제 exp계산을 하고 이들을 세로축으로 덧셈을 해줍니다.(왜 세로축인지 도저히 모르겠음)
